...
<template>
    <NavBar />
   <div class=" flex flex-col items-center justify-center h-fit  m-2" v-if="planet">
  ...
  :alt="planet.name" class="w-96 ">
    ...
    <div class=" ml-5 container flex flex-col  items-center p-4 text-left h-80 
    bg-base-300 ">
        <h3 class="text-2xl font-bold font-serif ">Facts about {{planet.name}} </h3>
        <p class="p-6 text-info-content ">
            {{ planet.facts }}
        </p>
    </div>
